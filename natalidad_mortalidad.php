...
if ($_GET) {
	...
	foreach($result as $row) {
		...
		$datos["datos"] .= "<tr><td>20-24 a&ntilde;os</td><td align='right'>".$row[0]."%</td></tr>";
		$datos["datos"] .= "<tr><td>25-29 a&ntilde;os</td><td align='right'>".$row[1]."%</td></tr>";
		$datos["datos"] .= "<tr><td>30-34 a&ntilde;os</td><td align='right'>".$row[2]."%</td></tr>";
		$datos["datos"] .= "<tr><td>35-39 a&ntilde;os</td><td align='right'>".$row[3]."%</td></tr>";
		$datos["datos"] .= "<tr><td>40-44 a&ntilde;os</td><td align='right'>".$row[4]."%</td></tr>";
		$datos["datos"] .= "<tr><td>45-49 a&ntilde;os</td><td align='right'>".$row[5]."%</td></tr>";
		$datos["datos"] .= "<tr><td>50-54 a&ntilde;os</td><td align='right'>".$row[6]."%</td></tr>";
		$datos["datos"] .= "<tr><td>55-59 a&ntilde;os</td><td align='right'>".$row[7]."%</td></tr>";
		$datos["datos"] .= "<tr><td>60-64 a&ntilde;os</td><td align='right'>".$row[8]."%</td></tr>";
		$datos["datos"] .= "<tr><td>65-69 a&ntilde;os</td><td align='right'>".$row[9]."%</td></tr>";
		$datos["datos"] .= "<tr><td>70-74 a&ntilde;os</td><td align='right'>".$row[10]."%</td></tr>";
		$datos["datos"] .= "<tr><td>75-79 a&ntilde;os</td><td align='right'>".$row[11]."%</td></tr>";
		$datos["datos"] .= "<tr><td>80-84 a&ntilde;os</td><td align='right'>".$row[12]."%</td></tr>";
		$datos["datos"] .= "<tr><td>85 a&ntilde;os y m&aacute;s</td><td align='right'>".$row[13]."%</td></tr>";
		$datos["datos"] .= "</table>";
