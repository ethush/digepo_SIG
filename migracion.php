...
if ($_GET) {
	...
	foreach($result as $row) {
		...
		$datos["datos"] .= "<tr><td><strong>Poblaci&oacute;n nacida en la entidad</strong></td><td align='right'><strong>".$row[0]."</strong></td><td align='right'><strong>".$row[1]."</strong></td><td align='right'><strong>".$row[2]."</strong></td></tr>";
		$datos["datos"] .= "<tr><td></td><td align='right'>".$row[3]."</td><td align='right'>".$row[4]."</td><td align='right'>".$row[5]."</td></tr>";
		$datos["datos"] .= "<tr><td><strong>Poblaci&oacute;n nacida en otra entidad.</strong></td><td align='right'><strong>".$row[6]."</strong></td><td align='right'><strong>".$row[7]."</strong></td><td align='right'><strong>".$row[8]."</strong></td></tr>";
		$datos["datos"] .= "<tr><td></td><td align='right'>".$row[9]."</td><td align='right'>".$row[10]."</td><td align='right'>".$row[11]."</td></tr>";
		$datos["datos"] .= "<tr><td><strong>Poblaci&oacute;n de 5 a&ntilde;os y m&aacute;s residentes en la entidad en junio de 2005.</strong></td><td align='right'>".$row[12]."</td><td align='right'>".$row[13]."</td><td align='right'>".$row[14]."</td></tr>";
		$datos["datos"] .= "<tr><td><strong>Poblaci&oacute;n de 5 a&ntilde;os y m&aacute;s residente en otra entidad en junio de 2005.</strong></td><td align='right'>".$row[15]."</td><td align='right'>".$row[16]."</td><td align='right'>".$row[17]."</td></tr>";
		$datos["datos"] .= "</table>";
