...
function addData($datos){
	...
	$detalles["region1"] = $mcrypt->encrypt("http://docs.google.com/gview?embedded=true&url=http://www.gioax.com.mx/digepo_SIG/data/regiones/canada.pdf");
	$detalles["region2"] = $mcrypt->encrypt("http://docs.google.com/gview?embedded=true&url=http://www.gioax.com.mx/digepo_SIG/data/regiones/costa.pdf");
	$detalles["region3"] = $mcrypt->encrypt("http://docs.google.com/gview?embedded=true&url=http://www.gioax.com.mx/digepo_SIG/data/regiones/istmo.pdf");
	$detalles["region4"] = $mcrypt->encrypt("http://docs.google.com/gview?embedded=true&url=http://www.gioax.com.mx/digepo_SIG/data/regiones/mixteca.pdf");
	$detalles["region5"] = $mcrypt->encrypt("http://docs.google.com/gview?embedded=true&url=http://www.gioax.com.mx/digepo_SIG/data/regiones/papaloapam.pdf");
	$detalles["region6"] = $mcrypt->encrypt("http://docs.google.com/gview?embedded=true&url=http://www.gioax.com.mx/digepo_SIG/data/regiones/sierra_norte.pdf");
	$detalles["region7"] = $mcrypt->encrypt("http://docs.google.com/gview?embedded=true&url=http://www.gioax.com.mx/digepo_SIG/data/regiones/sierra_sur.pdf");
	$detalles["region8"] = $mcrypt->encrypt("http://docs.google.com/gview?embedded=true&url=http://www.gioax.com.mx/digepo_SIG/data/regiones/valles_centrales.pdf");

	$detalles["url_state"] = $mcrypt->encrypt("http://docs.google.com/gview?embedded=true&url=http://www.gioax.com.mx/digepo_SIG/data/estatal/oaxaca.pdf");
